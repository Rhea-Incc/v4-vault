...
export const MACS: Mac[] = [
  { slug: "macbook-pro", name: "MacBook Pro", tagline: "Mind-blowing. Head-turning.", price: "From $1,599", image: MEDIA.macbook, alt: "MacBook Pro open on a desk", specs: ["M4 Pro or M4 Max", '14" or 16" Liquid Retina XDR', "Up to 24 hrs battery"] },
  { slug: "macbook-air", name: "MacBook Air", tagline: "Lean. Mean. M4 machine.", price: "From $999", image: MEDIA.macPerformance, alt: "MacBook Air shown at an angle", specs: ["M4 chip", '13" or 15" Liquid Retina', "Up to 18 hrs battery"] },
  { slug: "imac", name: "iMac", tagline: "Colourfully considered.", price: "From $1,299", image: MEDIA.macosHero, alt: "iMac displaying a colourful macOS desktop", specs: ["M4 chip", '24" 4.5K Retina', "Seven finishes"] },
  { slug: "mac-mini", name: "Mac mini", tagline: "Small, but mighty.", price: "From $599", image: MEDIA.spotlight, alt: "macOS Spotlight search shown on a Mac display", specs: ["M4 or M4 Pro", "Thunderbolt 5", "Five inches square"] },
  { slug: "mac-studio", name: "Mac Studio", tagline: "Empower station.", price: "From $1,999", image: MEDIA.macos, alt: "macOS desktop environment on a studio display", specs: ["M4 Max or M3 Ultra", "Up to 512GB memory", "Extensive I/O"] },
  { slug: "studio-display", name: "Studio Display", tagline: "A sight to be held.", price: "From $1,599", image: MEDIA.performance, alt: "Studio Display showing a high-detail image", specs: ['27" 5K Retina', "12MP Center Stage camera", "Six-speaker sound"] },
];
